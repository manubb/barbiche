# [Barbiche](https://manubb.github.io/barbiche/index.html) - Template engine for DOM &amp; JS

##Overview

[Barbiche](https://manubb.github.io/barbiche/index.html) is a logic-full template engine for browser environment. It has been designed to give you complete control over the data you want to merge into an HTML fragment. Current version is considered as a release candidate. Once minified and gzipped, Barbiche size is less than 11KB.
