...
case 2:
    ...
    return order.bind(null, yyvstack[$0 - 2], yyvstack[$0 - 1]);
    break;
...
case 32:
    ...
    this.$ = singleton.bind(null, yyvstack[$0]);
    break;
...
case 33:
    ...
    this.$ = push.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;
...
case 9:
    ...
    this.$ = bbObj.bind(yy, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 10:
    /*! Production::    SimpleExpression : SimpleExpression "||" SimpleExpression */
    this.$ = OR.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 11:
    /*! Production::    SimpleExpression : SimpleExpression "&&" SimpleExpression */
    this.$ = AND.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 12:
    /*! Production::    SimpleExpression : SimpleExpression "==" SimpleExpression */
    this.$ = EQUAL.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 13:
    /*! Production::    SimpleExpression : SimpleExpression "!=" SimpleExpression */
    this.$ = NOT_EQ.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 14:
    /*! Production::    SimpleExpression : SimpleExpression "<=" SimpleExpression */
    this.$ = LEQ.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 15:
    /*! Production::    SimpleExpression : SimpleExpression ">=" SimpleExpression */
    this.$ = GEQ.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 16:
    /*! Production::    SimpleExpression : SimpleExpression "<" SimpleExpression */
    this.$ = LESS.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 17:
    /*! Production::    SimpleExpression : SimpleExpression ">" SimpleExpression */
    this.$ = GREATER.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 18:
    /*! Production::    SimpleExpression : SimpleExpression "+" SimpleExpression */
    this.$ = plus.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;

case 19:
    /*! Production::    SimpleExpression : "!" SimpleExpression */
    this.$ = NOT.bind(null, yyvstack[$0]);
    break;
...
case 25:
    ...
    this.$ = call.bind(null, yyvstack[$0 - 1], yyvstack[$0]);
    break;

case 26:
    /*! Production::    SimpleExpression : SimpleExpression "[" SimpleExpression "]" */
    this.$ = getProperty.bind(null, yyvstack[$0 - 3], yyvstack[$0 - 1]);
    break;

case 27:
    /*! Production::    SimpleExpression : SimpleExpression "." PropertyName */
    this.$ = getProperty.bind(null, yyvstack[$0 - 2], yyvstack[$0]);
    break;
